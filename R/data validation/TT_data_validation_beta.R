...
# Step 4: 加入連結欄位
df_duplicates_reasoned$TT_URL <- sprintf("https://vvtaxatree.tbn.org.tw/taxa/%s", df_duplicates_reasoned$taxonUUID)

# Step 5: 輸出結果
fwrite(df_duplicates_reasoned, "../../data/output/TT_to_TC_beta/TT_duplicates_result_vers2.csv")
...
df_errors$TT_URL <- sprintf("https://vvtaxatree.tbn.org.tw/taxa/%s", df_errors$taxonUUID)


# (B3) 輸出到csv
fwrite(df_errors, "../../data/output/TT_to_TC_beta/TT_errortypes_result.csv")
...
df_TT_attribute_error$TT_URL <- sprintf("https://vvtaxatree.tbn.org.tw/taxa/%s", df_TT_attribute_error$taxonUUID)
fwrite(df_TT_attribute_error, "../../data/output/TT_to_TC_beta/TT_attributeerror_result.csv")
...
df_TT_without_species$TT_URL <- sprintf("https://vvtaxatree.tbn.org.tw/taxa/%s", df_TT_without_species$taxonUUID)


fwrite(df_TT_without_species, "../../data/output/TT_to_TC_beta/TT_without_species.csv")
...
df_TT_nomenclaturalCode$TT_URL <- sprintf("https://vvtaxatree.tbn.org.tw/taxa/%s", df_TT_nomenclaturalCode$taxonUUID)

fwrite(df_TT_nomenclaturalCode, "../../data/output/TT_to_TC_beta/TT_nomenclaturalCode.csv")
...
df_speciesinfraspecies_attribute_mismatch$TT_URL <- sprintf("https://vvtaxatree.tbn.org.tw/taxa/%s", df_speciesinfraspecies_attribute_mismatch$taxonUUID)
fwrite(df_speciesinfraspecies_attribute_mismatch, "../../data/output/TT_to_TC_beta/TT_speciesinfraspecies_attribute_mismatch.csv")
